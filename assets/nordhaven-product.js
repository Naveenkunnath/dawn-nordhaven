...
function updateVariantPrice(selectedVariant){
    document.querySelector('#ProductPrice .product__price-current').innerHTML = formatMoney(selectedVariant.price);
}
function updateVariantComparePrice(selectedVariant){
    if(selectedVariant.compare_at_price){
        document.querySelector('#ProductPrice .product__price-compare').innerHTML = formatMoney(selectedVariant.compare_at_price);
    }
    else {
...
function updateProductMedia(media){
    ...
    newImage.onload = function () {
        ...
        productImage.alt =
            media.featured_image.alt || media.name;
